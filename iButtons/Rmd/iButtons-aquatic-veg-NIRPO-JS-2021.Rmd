...
Here is a plot of the average daily temperature of each iButton from July 19 to August 23.
...
### What's going on at the sediment surface?

Let's take a closer look at the differences in temperature at the sediment surface by plot type. As we've seen the coldest temperatures are at the pond bottoms are in plots characterized by thick moss.
...
p <- ggplot(sedi_shmoss_filter, aes(x = Date, y = avg_daily_temp)) +
  ...
  facet_wrap(~Plot_ID, ncol = 4) + 
  labs(title = "Avg. Daily Temp at Sediment Layer in Shallow Moss Plots", x = NULL, y = "Temperature (\u00B0C)") +
  theme(plot.title = element_text(hjust = 0.5), axis.text.x = element_text(angle=45, hjust = 1))
...
p <- ggplot(sedi_aqforb_filter, aes(x = Date, y = avg_daily_temp)) +
  ...
  facet_wrap(~Plot_ID, ncol = 4) + 
  labs(title = "Avg. Daily Temp at Sediment Layer in Aquatic Forb Plots", x = NULL, y = "Temperature (\u00B0C)") +
  theme(plot.title = element_text(hjust = 0.5), axis.text.x = element_text(angle=45, hjust = 1))
...
Finally, we observe the warmest temperatures at the pond bottom (sediment surface location) in plots without significant vegetation of any type (bare plots).
...
p <- ggplot(sedi_bare_filter, aes(x = Date, y = avg_daily_temp)) +
  ...
  facet_wrap(~Plot_ID, ncol = 4) + 
  labs(title = "Avg. Daily Temp at Sediment Layer in Bare Plots", x = NULL, y = "Temperature (\u00B0C)") +
  theme(plot.title = element_text(hjust = 0.5), axis.text.x = element_text(angle=45, hjust = 1))
